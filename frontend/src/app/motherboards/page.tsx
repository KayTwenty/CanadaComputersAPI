...
import { TbArrowLeft, TbServer } from 'react-icons/tb';
                ...
                <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 pt-6 sm:pt-8 pb-6">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-rose-100 flex items-center justify-center">
                            <TbServer size={20} className="text-rose-600" />
                        </div>
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-0.5">
                                Every motherboard on sale at Canada Computers{storeId !== null && <> at <span className="font-semibold text-slate-700">{selectedStore.name}</span></>}
                            </p>
                        </div>
                    </div>
                </div>
