...
import { TbArrowLeft, TbDeviceLaptop } from 'react-icons/tb';
...
export default function LaptopsPage() {
    ...
    return (
        <>
            <div className="border-b border-slate-200/60 bg-linear-to-b from-blue-50/50 to-white">
                <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 pt-6 sm:pt-8 pb-6">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center">
                            <TbDeviceLaptop size={20} className="text-blue-600" />
                        </div>
                        <div>
