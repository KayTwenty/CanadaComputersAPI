...
export default function CpuPage() {
    ...
    return (
        <>
            <div className="border-b border-slate-200/60 bg-linear-to-b from-orange-50/50 to-white">
                <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 pt-6 sm:pt-8 pb-6">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-orange-100 flex items-center justify-center">
                            <TbCpu2 size={20} className="text-orange-600" />
                        </div>
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-0.5">
                                Every processor on sale at Canada Computers{storeId !== null && <> at <span className="font-semibold text-slate-700">{selectedStore.name}</span></>}
                            </p>
                        </div>
                    </div>
                </div>
