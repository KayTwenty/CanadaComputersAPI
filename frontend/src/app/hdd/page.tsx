...
import { TbArrowLeft, TbDisc } from 'react-icons/tb';
...
export default function HddPage() {
    ...
    return (
        <>
            <div className="border-b border-slate-200/60 bg-linear-to-b from-stone-50/50 to-white">
                <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 pt-6 sm:pt-8 pb-6">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-stone-100 flex items-center justify-center">
                            <TbDisc size={20} className="text-stone-600" />
                        </div>
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-0.5">
                                Every internal HDD on sale at Canada Computers{storeId !== null && <> at <span className="font-semibold text-slate-700">{selectedStore.name}</span></>}
                            </p>
                        </div>
                    </div>
                </div>
