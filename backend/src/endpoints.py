...
from services import product_search, get_cached_desktop_deals, get_cached_memory_deals, get_cached_cpu_deals, get_cached_gpu_deals, get_cached_laptop_deals, cache_status, VALID_STORE_IDS
    ...
    def get(self):
        ...
        if pickup_raw is not None:
            try:
                ...
                store_id = None
        resp = jsonify(get_cached_cpu_deals(store_id=store_id))
        resp.headers['Access-Control-Allow-Origin'] = '*'
        resp.status_code = 200
        return resp
    ...
    def get(self):
        ...
        if pickup_raw is not None:
            try:
                ...
                store_id = None
        resp = jsonify(get_cached_gpu_deals(store_id=store_id))
        resp.headers['Access-Control-Allow-Origin'] = '*'
        resp.status_code = 200
        return resp
    ...
    def get(self):
        ...
        if pickup_raw is not None:
            try:
                ...
                store_id = None
        resp = jsonify(get_cached_laptop_deals(store_id=store_id))
        resp.headers['Access-Control-Allow-Origin'] = '*'
        resp.status_code = 200
        return resp